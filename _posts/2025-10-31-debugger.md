...
Extensions where able to get cookies from a runtime_blocked_host using the chrome.debugger API via `Storage.getCookies` <https://chromedevtools.github.io/devtools-protocol/tot/Storage/#method-getCookies> there may be other APIs that leak information.
