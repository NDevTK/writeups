---
title: XS-Search on Google Photos + COOP bypass
---
...
Abuses the Chromium auto reloader using an invalid server response, also worked with max redirect limit.
...
Same trick also worked for an extension WAR (web accessible resources) bypass; that issue was fixed in <https://issues.chromium.org/40060076> and awarded $1000
