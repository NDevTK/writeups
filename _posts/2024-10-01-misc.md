...
- <https://apis.google.com/additnow/l?__ls=ogb&__lu=https://example.com>
- <https://voice.google.com/legacy%40example.com>
- <https://www.google.com/amp/a/s/example.com> (Google services, otherwise manual)
- <https://mail.google.com/amp/a/s/example.com> (Google services, otherwise manual)
- <https://dialogflow.cloud.google.com/redirect?encoded_url=https://example.com>
...
- <https://www.google.com/url?q=https://example.com> (Google services, otherwise manual)
- <https://accounts.google.com/ServiceLogin?continue=https%3A%2F%2Fexample.com> (Google services)
- <https://accounts.youtube.com/accounts/SetSID?continue=https://example.com> (Google services)
- <https://youtube.com/signin?next=https://admin.youtube.com/> (YouTube services)
- <https://www.youtube.com/logout?continue=https%3A%2F%2Fexample.com> (Logout, Google services)
- <https://accounts.google.com/logout?continue=https%3A%2F%2Fexample.com> (Logout, Google services)
- <https://www.youtube.com/redirect?q=https%3A%2F%2Fexample.com> (Manual)
- <https://chromium.googlesource.com/login//example.com>
- <https://chromium-review.googlesource.com/login/?continue=\\example.com>

# Chrome page download button spoof, Fixed

The chrome download page checks download host URL parameter with bypassable `startsWith`.

```js
Se = 'https://dl.google.com';

s =
  e.get(C.FALLBACK_INSTALLER_PATH) &&
  e.get(C.FALLBACK_INSTALLER_PATH).startsWith(Se)
    ? e.get(C.FALLBACK_INSTALLER_PATH)
    : this.storage_.getItem(A.INSTALLER_PATH);
```

**Attack Preconditions**

Victim gets sent a link no popups needed.

**Reproduction Steps / POC**

Go to <https://www.google.com/chrome/?wp=https%3A%2F%2Fdl.google.com%40discord.com%2Fapi%2Fdownloads%2Fdistributions%2Fapp%2Finstallers%2Flatest%3Fchannel%3Dstable%26platform%3Dwin%26arch%3Dx64> and click the `Download Chrome` button notice it downloads Discord instead of Chrome.

### Attack scenario

Users rely on the context in which the file download was initiated in this case that's clicking the real download button on the trusted Chrome download page.
