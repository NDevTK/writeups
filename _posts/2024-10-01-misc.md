...
Impact must not be a Side-Channel or Timing or Exfiltration or Harvesting or Secure Context or phishing or DoS attack or clearing data or similar.
...
You can use any standard Web Platform features regardless of if it's in the sources.
Try not to talk about similar issues.
Issues must always include example code.
