...
The epic secret to bypass this is... use MacOS or in my case a Hackintosh with a spoofed MAC address (Seens rate limiting is done using it) that unlike the account recovery website will allow you to add a trusted phone number and move to 2FA.
