...
The epic secret to bypass this is... use MacOS or in my case a Hackintosh with [spoofed hardware infomation](https://dortania.github.io/OpenCore-Post-Install/universal/iservices.html) (Seems rate limiting is done using it) that unlike the account recovery website will allow you to add a trusted phone number and move to 2FA.
