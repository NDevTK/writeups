...
for name in ozone no2 cloud-corona cloud-climatology moonlight overcast adaptation stars-color planets-color stratos volcanic bishop psc aureole ocean atmo moon lunar-umbra optics surf glint coxmunk aurora steve leadr radar igrf scintillation ross-li cn2 airglow gwaves zodiacal meteors comets contrails ships navlights aircraft airline wildfire lightning sprites blondel tides milkyway earthshine nlc sats satmags eclipses skyglow rainbow fogbow halos explore roam solarwind metar seasmoke clearness refraction smoke terrain-sample far-terrain spectral sunspots lakes buildings facade roads landuse rivers rails trains aerialways turbines wakes peaks snowcover snowage seaice meltpond lakeice grib2 aerosol aeronet nightlights lightpillars morel ocean-glint ocean-color ocean-measured-color vegetation land-color surface-color spectral-color crops livery forest grassland bldlod linelod veglod kelvin corona waterfalls powerlines geotiles modis-land phenology server; do
