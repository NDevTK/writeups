  ...
  return {
    ...
    addToRenderList: function (t, n) {
      ...
      i && (i.isCubeTexture || i.mapping === a)
        ? (void 0 === S &&
          ...
          (S.material.uniforms.backgroundBlurriness.value =
        ...
        : i &&
          ...
          (E.material.uniforms.backgroundIntensity.value =
            n.backgroundIntensity),
    ...
    dispose: function () {
      (void 0 !== S &&
        ...
        void 0 !== E &&
          (E.geometry.dispose(), E.material.dispose(), (E = void 0)));
    }
  };
}
function Xn(e, t) {
...
function Yn(e, t, n, i) {
  ...
  const s = a(o);
  s !== o &&
    (v('WebGLRenderer:', o, 'not supported, using', s, 'instead.'), (o = s));
...
class ri {
  ...
  compileCubemapShader() {
    null === this._cubemapMaterial &&
      ((this._cubemapMaterial = li()),
      this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    null === this._equirectMaterial &&
      ((this._equirectMaterial = si()),
    ...
    for (let t = 0; t < 6; t++) {
      ...
      0 === n
        ? (a.up.set(0, l[t], 0),
          ...
          a.lookAt(r.x + d[t], r.y, r.z))
        : 1 === n
          ? (a.up.set(0, 0, l[t]),
            a.position.set(r.x, r.y, r.z),
            a.lookAt(r.x, r.y + d[t], r.z))
          : (a.up.set(0, l[t], 0),
            a.position.set(r.x, r.y, r.z),
            a.lookAt(r.x, r.y, r.z + d[t]));
...
function fi(e) {
  ...
  return {
    ...
    get: function (e) {
      const t = n(e);
      return (
        null === t && W('WebGLRenderer: ' + e + ' extension not supported.'),
        t
      );
    }
  };
...
function mi(e, t, n) {
  ...
  ((this.setMode = function (e) {
    ...
    (this.renderInstances = function (t, o, s) {
      0 !== s &&
        (e.drawElementsInstanced(i, o, r, t * a, s), n.update(o, i, s));
    }),
    ...
    update: function (o, s, l) {
      ...
      if (void 0 === f || f.count !== u) {
        ...
        let S = s.attributes.position.count * E,
          T = 1;
        S > n.maxTextureSize &&
          ((T = Math.ceil(S / n.maxTextureSize)), (S = n.maxTextureSize));
        ...
        i.isInstancedMesh &&
          ...
          a.get(i) !== s &&
            ...
            null !== i.instanceColor &&
              n.update(i.instanceColor, e.ARRAY_BUFFER),
            a.set(i, s))),
        i.isSkinnedMesh)
      ) {
        const e = i.skeleton;
...
function Zi(e, t, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (e.uniform1i(this.addr, r), (i[0] = r)),
    n.setTexture3D(t || xi, r));
}
function $i(e, t, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (e.uniform1i(this.addr, r), (i[0] = r)),
    n.setTextureCube(t || Ri, r));
}
function Qi(e, t, n) {
  const i = this.cache,
    r = n.allocateTextureUnit();
  (i[0] !== r && (e.uniform1i(this.addr, r), (i[0] = r)),
    n.setTexture2DArray(t || Ti, r));
}
function Ji(e, t) {
...
function Lr(e, t) {
  const n = (function (e) {
    ...
    switch (f.getTransfer(e)) {
      ...
      default:
        return (
          v('WebGLProgram: Unsupported color space: ', e),
...
function jr(e, t, n, i) {
  ...
  const l = (function (e) {
    ...
    c = (function (e) {
      return !1 === e.envMap
        ? 'ENVMAP_TYPE_CUBE'
        : Kr[e.envMapMode] || 'ENVMAP_TYPE_CUBE';
    })(n),
    d = (function (e) {
      return !1 === e.envMap
    ...
    u = (function (e) {
      return !1 === e.envMap
        ...
        : qr[e.combine] || 'ENVMAP_BLENDING_NONE';
    })(n),
    f = (function (e) {
  ...
  function R(t) {
    if (e.debug.checkShaderErrors) {
      ...
      if (!1 === r.getProgramParameter(h, r.LINK_STATUS))
        ...
        '' !== o
          ? v('WebGLProgram: Program Info Log:', o)
          : ('' !== s && '' !== l) || (d = !1);
      d &&
        (t.diagnostics = {
          runnable: c,
...
function Jr(e, t, n, i, r, o) {
  ...
  return {
    getParameters: function (r, s, u, m, S, M) {
      ...
      let Le = L;
      r.toneMapped &&
        ((null !== F && !0 !== F.isXRRenderTarget) || (Le = e.toneMapping));
      const Ue = {
        shaderID: P,
        shaderType: r.type,
        shaderName: r.name,
        ...
        gradientMap: Re,
        opaque:
          !1 === r.transparent && r.blending === _e && !1 === r.alphaToCoverage,
        alphaMap: Ae,
        alphaTest: be,
        alphaHash: Ce,
        combine: r.combine,
        ...
        decodeVideoTexture:
          ...
          f.getTransfer(r.map.colorSpace) === p,
        decodeVideoTextureEmissive:
          j &&
          !0 === r.emissiveMap.isVideoTexture &&
          f.getTransfer(r.emissiveMap.colorSpace) === p,
    ...
    acquireProgram: function (t, n) {
      ...
      return (
        void 0 !== i
          ? ++i.usedTimes
          : ((i = new jr(e, n, t, r)), u.push(i), m.set(n, i)),
        i
      );
    },
    ...
    setup: function (t) {
      ...
      (u > 0 &&
        (!0 === e.has('OES_texture_float_linear')
          ? ((a.rectAreaLTC1 = Gn.LTC_FLOAT_1),
            (a.rectAreaLTC2 = Gn.LTC_FLOAT_2))
          : ((a.rectAreaLTC1 = Gn.LTC_HALF_1),
            (a.rectAreaLTC2 = Gn.LTC_HALF_2))),
        (a.ambient[0] = i),
        (a.ambient[1] = o),
        (a.ambient[2] = s));
      const E = a.hash;
...
function _a(e, n, i) {
  ...
  function C(t, i) {
    ...
    (g.defines.VSM_SAMPLES !== t.blurSamples &&
      ...
      (S.needsUpdate = !0)),
      null === t.mapPass &&
        (t.mapPass = new I(a.x, a.y, {format: Se, type: E})),
  ...
  function P(t, n, i, r) {
    ...
    if (void 0 !== o) a = o;
      ...
      let r = i[t];
      (void 0 === r &&
        ((r = a.clone()), (i[t] = r), n.addEventListener('dispose', U)),
        (a = r));
    }
    if (
      ((a.visible = n.visible),
  ...
  this.render = function (t, n, i) {
    ...
    for (let o = 0, l = t.length; o < l; o++) {
      ...
      (a.multiply(p),
        ...
        (a.x > m || a.y > m) &&
          (a.x > m &&
            ((s.x = Math.floor(m / p.x)),
            (a.x = s.x * p.x),
            (c.mapSize.x = s.x)),
          a.y > m &&
            ((s.y = Math.floor(m / p.y)),
            (a.y = s.y * p.y),
            (c.mapSize.y = s.y))));
      ...
      if (((c.camera._reversedDepth = h), null === c.map || !0 === f)) {
        if (
          ...
          (l.isPointLight
            ...
            : ((c.map = new I(a.x, a.y)),
              (c.map.depthTexture = new Y(a.x, a.y, Le))),
      ...
      for (let t = 0; t < _; t++) {
        if (c.map.isWebGLCubeRenderTarget)
          (e.setRenderTarget(c.map, t), e.clear());
        else {
        ...
        if (l.isPointLight) {
          ...
          (i !== e.far && ((e.far = i), e.updateProjectionMatrix()),
            ...
            c._frustum.setFromProjectionMatrix(
              pa,
              e.coordinateSystem,
              e.reversedDepth
            ));
      ...
      (!0 !== c.isPointLightShadow && this.type === le && C(c, i),
        (c.needsUpdate = !1));
    }
    ...
    if (t !== w) {
      if ((!1 === h && (X(e.BLEND), (h = !0)), t === ot))
        ((a = a || n),
          ...
          (s = s || r),
          (n === g && a === S) ||
            (e.blendEquationSeparate(q[n], q[a]), (g = n), (S = a)),
          (i === v && r === E && o === M && s === T) ||
            ...
            (T = s)),
          (!1 !== l.equals(x) && c === R) ||
            (e.blendColor(l.r, l.g, l.b, c), x.copy(l), (R = c)),
          (_ = t),
          (A = !1));
      else if (t !== _ || d !== A) {
        if (
          ((g === Ne && S === Ne) ||
            (e.blendEquation(e.FUNC_ADD), (g = Ne), (S = Ne)),
          d)
        )
          switch (t) {
            case _e:
...
function va(e, n, i, r, a, o, s) {
  ...
  function L(e, t) {
    return !0 === R(e) ||
      (e.isFramebufferTexture && e.minFilter !== Ce && e.minFilter !== O)
  ...
  function F(t, n) {
    ...
    if (
      ...
      const e = t.image;
      if (null === e)
        v('WebGLRenderer: Texture marked for update but no image data found.');
      else {
  ...
  function z(t, n) {
    ...
    void 0 === t.__webglInit &&
      ((t.__webglInit = !0), n.addEventListener('dispose', U));
    const r = n.source;
    let a = _.get(r);
  ...
  function X(t, n, s) {
    ...
    if (d.version !== u.__version || !0 === c) {
      ...
      if (
        !1 ===
        ('undefined' != typeof ImageBitmap && n.image instanceof ImageBitmap)
      ) {
      ...
      if (n.isDepthTexture)
                ...
                (function (t, n, r, a) {
                  ...
                  if (0 === o.length)
                    ...
                    for (let e = 1; e < o.length; e++) {
                      ...
                      i.start <= r + 1 &&
                      a === l &&
                      k(i.start + i.count - 1, n.width, 4) === a
                        ? (t.count = Math.max(
                            t.count,
        ...
        E
          ? (S &&
              i.texStorage3D(e.TEXTURE_3D, b, _, t.width, t.height, t.depth),
            M &&
              i.texSubImage3D(
                e.TEXTURE_3D,
                0,
        ...
        if (S)
          if (E) i.texStorage2D(e.TEXTURE_2D, b, _, t.width, t.height);
            ...
            let n = t.width,
              a = t.height;
            for (let t = 0; t < b; t++)
              (i.texImage2D(e.TEXTURE_2D, t, _, n, a, 0, r, p, null),
                (n >>= 1),
                (a >>= 1));
          }
        ...
        if ('texElementImage2D' in e) {
          const i = e.canvas;
          if (
            (i.hasAttribute('layoutsubtree') ||
              i.setAttribute('layoutsubtree', 'true'),
            t.parentNode !== i)
          )
            return (
              i.appendChild(t),
          ...
          if (3 === e.texElementImage2D.length)
            e.texElementImage2D(e.TEXTURE_2D, e.RGBA8, t);
          else {
            const n = 0,
              i = e.RGBA,
              r = e.RGBA,
  ...
  function j(t) {
    ...
    if (t.depthTexture && !n.__autoAllocateDepthBuffer)
      if (a) for (let e = 0; e < 6; e++) q(n.__webglFramebuffer[e], t, e);
        ...
        e && e.length > 0
          ? q(n.__webglFramebuffer[0], t, 0)
          : q(n.__webglFramebuffer, t, 0);
      }
    else if (a) {
      n.__webglDepthbuffer = [];
      for (let r = 0; r < 6; r++)
        if (
          ...
          ((n.__webglDepthbuffer[r] = e.createRenderbuffer()),
            Y(n.__webglDepthbuffer[r], t, !1));
        else {
          const i = t.stencilBuffer
              ? e.DEPTH_STENCIL_ATTACHMENT
              : e.DEPTH_ATTACHMENT,
        ...
        ? (function (t, n, s) {
            ...
            if (c.version !== d.__version || !0 === l) {
              ...
              if ((W(e.TEXTURE_CUBE_MAP, n), p)) {
                M &&
                  b &&
                  i.texStorage2D(e.TEXTURE_CUBE_MAP, D, S, _.width, _.height);
                for (let t = 0; t < 6; t++) {
                  U = h[t].mipmaps;
    ...
    convert: function (n, i = At) {
      ...
      if (
        ...
        if (((r = t.get('WEBGL_compressed_texture_etc')), null === r))
          return null;
        if (n === $t || n === Qt)
          return a === p ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
        if (n === Jt)
          return a === p
  ...
  constructor(e, n) {
    ...
    ((this.updateCamera = function (e) {
      ...
      let t = e.near,
        n = e.far;
      (null !== g.texture &&
        (g.depthNear > 0 && (t = g.depthNear),
        g.depthFar > 0 && (n = g.depthFar)),
        (N.near = D.near = U.near = t),
        (N.far = D.far = U.far = n),
        (y === N.near && O === N.far) ||
          (a.updateRenderState({depthNear: N.near, depthFar: N.far}),
          (y = N.near),
          (O = N.far)),
      ...
      (2 === r.length
        ? (function (e, t, n) {
            (H.setFromMatrixPosition(t.matrixWorld),
              V.setFromMatrixPosition(n.matrixWorld));
        ...
        (function (e, t, n) {
          ...
          (e.matrix.decompose(e.position, e.quaternion, e.scale),
            ...
            e.isPerspectiveCamera &&
              ((e.fov = 2 * Pn * Math.atan(1 / e.projectionMatrix.elements[5])),
              (e.zoom = 1)));
        })(e, N, i));
    }),
  ...
  function i(e, i) {
    ...
    (a &&
      ...
      e.envMapRotation.value
        .setFromMatrix4(Ta.makeRotationFromEuler(o))
        .transpose(),
      a.isCubeTexture &&
        !1 === a.isRenderTargetTexture &&
        e.envMapRotation.value.premultiply(xa),
      ...
      a[n.id] !== m &&
        (!(function (t) {
          ...
          for (let e = 0, t = i.length; e < t; e++) {
            const t = i[e];
            if (Array.isArray(t))
              for (let n = 0, i = t.length; n < i; n++) l(t[n], e, n, a);
            else l(t, e, 0, a);
          }
          e.bindBuffer(e.UNIFORM_BUFFER, null);
        })(n),
...
class Pa {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ('setAttribute' in t &&
          t.setAttribute('data-engine', `three.js r${wn}`),
    ...
    ((this.xr = je),
          ...
          if (e) {
            ...
            t
              ? ((b[0] = r),
                ...
                (b[2] = o),
                (b[3] = i),
                Ke.clearBufferuiv(Ke.COLOR, 0, b))
              : ((C[0] = r),
                (C[1] = a),
                (C[2] = o),
                (C[3] = i),
                Ke.clearBufferiv(Ke.COLOR, 0, C));
          } else i |= Ke.COLOR_BUFFER_BIT;
        }
        (t &&
          ((i |= Ke.DEPTH_BUFFER_BIT), this.state.buffers.depth.setMask(!0)),
          n &&
            ((i |= Ke.STENCIL_BUFFER_BIT),
      ...
      (this.renderBufferDirect = function (e, t, n, i, r, a) {
        ...
        const o = r.isMesh && r.matrixWorld.determinantAffine() < 0,
          s = (function (e, t, n, i, r) {
                          ...
                          ? (r.isInstancedMesh &&
                            ...
                            : void 0 === S.numClippingPlanes ||
                              ...
                              ? (S.vertexAlphas !== d ||
                                  ...
                                  !!S.lightProbeGrid !=
                                    w.state.lightProbeGridArray.length > 0) &&
                                (T = !0)
                              : (T = !0)
                          : (T = !0)
                      : (T = !0)
            ...
            !0 === T &&
              ((x = dt(i, t, r)),
              V && i.isNodeMaterial && V.onUpdateProgram(i, x, S));
            let R = !1,
              A = !1,
              b = !1;
            ...
            if (S.needsLights) {
              const e = (function (e, t) {
                ...
                for (let t = 0, n = e.length; t < n; t++) {
                  const n = e[t];
                  if (null !== n.texture && n.boundingBox.containsPoint(P))
                    return n;
                }
                return null;
            ...
            if (R || Z !== e) {
              ...
              (void 0 !== t &&
                t.setValue(Ke, me.setFromMatrixPosition(e.matrixWorld)),
            ...
            if (r.isSkinnedMesh) {
              (C.setOptional(Ke, r, 'bindMatrix'),
                C.setOptional(Ke, r, 'bindMatrixInverse'));
              const e = r.skeleton;
              e &&
        ...
        let g = Ve;
        if (
          (null !== l && ((_ = Pe.get(l)), (g = We), g.setIndex(_)), r.isMesh)
        )
          !0 === i.wireframe
            ? (xe.setLineWidth(i.wireframeLinewidth * Ee()),
              g.setMode(Ke.LINES))
          ...
          r.isPoints
            ? g.setMode(Ke.POINTS)
            : r.isSprite && g.setMode(Ke.TRIANGLES);
        if (r.isBatchedMesh)
          if (Me.get('WEBGL_multi_draw'))
            ...
            for (let i = 0; i < n; i++)
              (o.setValue(Ke, '_gl_DrawID', i), g.render(e[i] / a, t[i]));
          }
      ...
      (this.compileAsync = function (e, t, n = null) {
        ...
        return new Promise((t) => {
          ...
          null !== Me.get('KHR_parallel_shader_compile')
            ? n()
            : setTimeout(n, 10);
        });
      }));
    ...
    function st(e, t, n, i) {
      ...
      const r = w.state.transmissionRenderTarget[i.id],
        a = i.viewport || $;
      r.setSize(
        a.z * G.transmissionResolutionScale,
        a.w * G.transmissionResolutionScale
      );
      ...
      if (
        ...
        !0 === e &&
          (be.updateMultisampleRenderTarget(r), be.updateRenderTargetMipmap(r));
      }
    ...
    (rt.setAnimationLoop(function (e) {
      ...
      (this.render = function (e, t) {
        ...
        if (
          ...
          !0 !== je.enabled ||
            ...
            (!0 === je.cameraAutoUpdate && je.updateCamera(t),
            (t = je.getCamera())),
        ...
        if (!1 === (i && F.hasRenderPass())) {
          ...
          if ((w.setupLights(), t.isArrayCamera)) {
            ...
            (i.length > 0 && st(n, i, e, t), ve && Ge.render(e), ot(U, e, t));
        }
        (null !== q &&
          0 === Y &&
      ...
      (this.setRenderTargetTextures = function (e, t, n) {
        ...
        ((i.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
          ...
          (Ae.get(e.depthTexture).__webglTexture = i.__autoAllocateDepthBuffer
            ? void 0
            : n),
      ...
      (this.setRenderTarget = function (e, t = 0, n = 0) {
        ...
        if (e) {
          ...
          ($.copy(se).multiplyScalar(re).floor(),
            Q.copy(le).multiplyScalar(re).floor(),
            (J = ce));
        0 !== n && (i = W);
        if (
      ...
      (this.copyTextureToTexture = function (
        ...
        if (e.isDepthTexture) {
          ...
          const n = Ae.get(e),
            i = Ae.get(t);
          (xe.bindFramebuffer(Ke.READ_FRAMEBUFFER, z),
            xe.bindFramebuffer(Ke.DRAW_FRAMEBUFFER, k));
          for (let e = 0; e < l; e++)
            (R
              ? Ke.framebufferTextureLayer(
                  Ke.READ_FRAMEBUFFER,
