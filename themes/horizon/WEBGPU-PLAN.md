...
- DONE (Sep 7, the review session's 186th pass - THE SNOW'S COVER FROM
...
- DONE (Sep 7, the review session's 177th pass - THE ANVIL'S SPREAD):
  ...
  files, 1,200 landmarks, 9 GPU probes). MEASURED in the page (the
  Georgia coast, 31.65 N 81.25 W, 03:20 local, the 06:52Z window under
  the night's anvil): "436 good fields of the +-100 km window: low 9,
  mid 12, high 415 (11180 m) ... the cirrus sheets: 235 high pixels
  within 100 km as sheets at their parallax-corrected places (moved
  5.2-12.3 km toward the sub-satellite point at 39 deg zenith), tops
...
- DONE (Sep 6, the review session's 163rd pass - THE COLUMN'S WATER):
  ...
  km; 7 in the scene) clauses. The re-run measured on the second
  probe: the field first took 43.69 mm at the sea source (the CO-OPS
  pier's own good 10-km pixel) from the 13:47Z file, and when the
