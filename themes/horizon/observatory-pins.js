...
export const DAY_PINS = {
  ...
  marine: {
    stability: 'unstable',
    dTairSeaK: [-1, 0.05],
    filmLapseKm: [-16.722867743300707, 3],
    filmDropK: [0.15886724356135673, 0.05],
    pierTopM: 100,
    joinM: 716,
    modelBand: [100, 716],
    clamped: true,
    skinK: [0.3474403296880722, 0.02],
    dTairSkinK: [-0.652559670311927, 0.05],
    lwDnWm2: [342.89114858682336, 3],
    q0Wm2: [103.22492771588358, 3],
    dewSource: 'METAR KSAN (16 km)',
    lwSource:
      "modelled sky: Brunt on the pier's air + 0% cover from METAR KSAN",
    uMeasMs: 1.6,
    u10nMs: [1.741813368653929, 0.05],
    u10Ms: [1.6054990462458136, 0.05],
    warmK: [0, 0.02],
    warmSurfaceK: [0, 0.02],
    warmDzM: [19, 0.5],
